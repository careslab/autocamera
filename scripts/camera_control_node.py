...
class Teleop_class:
    ...
    def home_arms(self):
        ...
        q_psm1 = [0.23924254171060108, -0.01797852213119466, 0.14621632684000002, 0.8377113242206747, 0.17708090369601082, -0.09530868036608423, -0.17461480669754453]
        q_psm2 = [-0.44400308113778975, 0.27082851916617934, 0.14308708278, -1.218088881701602, 0.011340829480531557, -0.04330772064541742, -0.17461480669754453]
        q_mtml = [0.11491722297794404, 0.03243624427128457, 0.04138300552239829, -1.4775311119452081, 0.01776383092523609, 0.20724469412775437, -0.3493553312322004, 0.0]
        q_mtmr = [-0.20677173101894783, -0.0579758501975096, 0.060342694686797614, 1.5229264179134798, 0.10066170857633784, 0.18948086320251828, 0.4144893760382039, 0.0]
...
class bag_writer:
    ...
    def __init__(self, arm_names, bag_name='test', mode = MODE.simulation, recording_dir='recordings'):
        ...
        record_command = """rosbag record /dvrk/MTML/state_joint_current /dvrk/MTMR/state_joint_current /dvrk/PSM1/state_joint_current /dvrk/PSM2/state_joint_current /dvrk/ECM/state_joint_current /dvrk/footpedals/clutch /dvrk/footpedals/camera /dvrk/footpedals/coag /usb_cam/image_raw/compressed  --lz4 -O {}""".format(dir + bag_name + '_sim.bag' )
