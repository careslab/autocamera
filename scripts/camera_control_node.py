...
class bag_writer:
    ...
    def __init__(self, arm_names, bag_name='test', mode = MODE.simulation, recording_dir='recordings'):
        ...
        record_command = """rosbag record /dvrk/MTML/state_joint_current /dvrk/MTMR/state_joint_current /dvrk/PSM1/state_joint_current /dvrk/PSM2/state_joint_current /dvrk/ECM/state_joint_current /dvrk/footpedals/clutch /dvrk/footpedals/camera /dvrk/footpedals/coag /usb_cam_left/image_raw/compressed /usb_cam_right/image_raw/compressed  --lz4 -O {}""".format(dir + bag_name + '_sim.bag' )
