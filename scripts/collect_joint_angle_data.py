...
def main():
    global save, psm1_robot, psm1_kin, psm2_robot, psm2_kin
    ...
    rospy.Subscriber('/dvrk/PSM1/position_joint_current', JointState, psm1_read_cb)
    rospy.Subscriber('/dvrk/PSM2/position_joint_current', JointState, psm2_read_cb)
